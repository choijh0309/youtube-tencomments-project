...
## 개선할 점 
소프트웨어에서 가장 중요한 점은 **업데이트**와 **확장** 이라고 생각합니다. 소프트웨어는 기능이 작동된다고 다가 아닙니다.

서두에 얘기에서 언급했듯이 이 프로젝트의 목표는 사람의 생각을 알고 분석하는 것입니다. 저는 프로젝트를 구상할 때 업데이트와 확장에 중점을 두고 제한된 시간에 우선 핵심 기능을 구현했습니다. 핵심 기능을 구현했으니 이용자가 더 개인적인 관심을 찾아볼 수 있게 기능을 추가할 예정입니다.
